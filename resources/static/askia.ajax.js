...
(function () {
  ...
  askia.defaultEventActions = {
    ...
    askiaSetValue: null,
    askiaShowMessage: executeShowMessage,
  ...
  /**
   * Clear the live errors
   */
  function clearLiveErrors () {
    var className = '.askia-live-errors-summary';
   ...
   */
  function executeShowMessage (data) {
    var className = '.askia-live-errors-summary';
    var errorMessage = data.message;
    var element = document.querySelectorAll(className)[0];
      element.innerHTML = '<div>' + errorMessage + '</div>';
  }
